...
public partial class PackingListSummaryReport : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            foreach (DataRow dr in dtRole.Rows)
            {
                ...
                if (dtRole.Rows[row]["Page_Url"].ToString() == "PackingListSummaryReport.aspx")
                {
            ...
            {
                if (pageName == "PackingListSummaryReport.aspx" && view == true)
                {
    ...
    {
        string reportPath = Server.MapPath("GL_Report\\PackingListReport.rpt");
        //string reportPath = Server.MapPath("GL_Report\\PackingListReport.rpt");
        rd.Load(reportPath);
    ...
    private DataSet getreport()
    {
        ...
        con.Open();
        SqlCommand cmd = new SqlCommand("vt_SCGL_Sp_CommercialInvoiceReport", con);
    ...
    protected void lnkConYes_Click(object sender, EventArgs e)
    {
        ...
        if (GivenEPages != null)
        {
            ...
            lblDeleteMsg.Text = "Packing List Report Print Successfully ! ";
        }
        else
        {
            JQ.showDialog(this, "Confirmation");
