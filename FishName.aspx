<%@ Page Title="" Language="C#" MasterPageFile="Main.master" AutoEventWireup="true"
    CodeFile="FishName.aspx.cs" Inherits="FishName" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">

    <script type="text/javascript" language="javascript">
        $(document).ready(function() {
            CreateModalPopUp('#FishName', 330, 150, 'Add/Modify Fish Name');
                ...
                <tr>
                    ...
                    <td style="width: 332px; float: right;">
                        <asp:UpdatePanel ID="UpdatePanel3" runat="server">
                            <ContentTemplate>
                                <asp:LinkButton ID="btnNew" runat="server" CssClass="buttonImp" OnClick="btnNew_Click">Create Fish Name</asp:LinkButton>
                            </ContentTemplate>
                            <Triggers>
...
<br />
   <div class="box_body_Search">
        <div class="box_header"><span class="box_txt">Search Fish Name</span></div>
        <div class="box_inner">
           
            <asp:Label ID="Label1" runat="server" Text="Search By Fish Name : "></asp:Label>
        
            <asp:TextBox ID="txtSearchFishName" runat="server" 
                ontextchanged="txtSearchFishName_TextChanged" ></asp:TextBox> 
    ...
    <div class="box_header" style="margin-bottom: 8px;"><span class="box_txt">Manage Fish Name</span></div>
                ...
                <div align="center">
                    <div style="width: 600px;">
                        <asp:GridView ID="GridFish" CssClass="main data" runat="server" AutoGenerateColumns="False"
                            DataKeyNames="FishID" AllowPaging="true" PageSize="14" OnPageIndexChanging="GridFish_PageIndexChanging">
                            <Columns>
                               <%-- <asp:BoundField DataField="FishID" HeaderText="FishID" InsertVisible="False" ItemStyle-HorizontalAlign="Center"
                                ...
                                <asp:BoundField DataField="FishName" HeaderText="FishName" SortExpression="FishName" />
                                <asp:TemplateField HeaderText="Edit" HeaderStyle-Width="31px">
                                    <ItemTemplate>
                                        <asp:UpdatePanel ID="UpdatePanel2" runat="server">
                                            <ContentTemplate>
                                                <asp:LinkButton ID="lbtnEdit" runat="server" CommandArgument='<%# Eval("FishID") %>'
                                                Enabled='<%# Eval("ISEnabled") %>' OnCommand="lbtnEdit_Command" CssClass="edit"></asp:LinkButton>
                                            </ContentTemplate>
                                            <Triggers>
                                ...
                                <asp:TemplateField HeaderText="Delete" HeaderStyle-Width="41px">
                                    <ItemTemplate>
                                        <asp:LinkButton ID="lbtnDelete" runat="server" CssClass="delete" CommandArgument='<%# Eval("FishID") %>' Enabled='<%# Eval("ISEnabled") %>'
        ...
        <div id="FishName" style="padding-top: 19px; display: none;">
                ...
                <ContentTemplate>
                    <table>
                        <tr>
                            ...
                            <td>
                                <asp:TextBox ID="txtFishID" runat="server" AutoComplete="Off" ReadOnly="True"></asp:TextBox>
                            </td>
                        </tr>
                        <tr>
                            <td>
                            ...
                            <td>
                                <asp:TextBox ID="txtFishName" require="Enter Fish Name" placeholder="Fish Name" validate="CostCenterL" runat="server"></asp:TextBox>
                            </td>
                        </tr>
                        <tr>
                            <td>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <asp:LinkButton ID="btnCancal" CssClass="Button1" runat="server" OnClientClick="return closeDialog('FishName');">Cancel</asp:LinkButton>
                            </td>
                        </tr>
                    </table>
                </ContentTemplate>
