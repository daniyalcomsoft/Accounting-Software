<%@ Page Title="Balance Sheet report" Language="C#" MasterPageFile="Main.master" AutoEventWireup="true" CodeFile="BalanceSheetReportSummary.aspx.cs" Inherits="BalanceSheetReportSummary" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div id="StausMsg">
        ...
        <td>
             <asp:TextBox ID="txt_AsOfDate" CssClass="DateTimePicker" placeholder="Date" Width="171px" runat="server" MaxLength="40" require="Select Date" validate="Rpt"></asp:TextBox>                  
            </td>
             
             <td><asp:LinkButton CssClass="buttonImp" 
