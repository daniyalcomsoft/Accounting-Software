<%@ Page Title="" Language="C#" MasterPageFile="Main.master" AutoEventWireup="true" CodeFile="InventoryReportSummary.aspx.cs" Inherits="InventoryReportSummary" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class="Heading">Inventory Summary</div>
    <div id="StausMsg">
    </div>
        <div> 
         <table>
