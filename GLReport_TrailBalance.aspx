...
CodeFile="GLReport_TrailBalance.aspx.cs" Inherits="testing" Title="Trial Balance Report" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
  <asp:HiddenField ID="hdnMinDate" runat="server" />
    ...
    <div class="Heading">Trial Balance</div>
    <div id="StausMsg">
    </div>
        <div>
                
                <b><asp:Label ID="Label1" runat="server" Text="Detail Type"></asp:Label>            </b>
                <asp:DropDownList ID="DropdownlistDetails" runat="server" 
                AutoPostBack="true" 
                onselectedindexchanged="DropdownlistDetails_SelectedIndexChanged">
                <asp:ListItem Value="1">Main Account</asp:ListItem>
                <asp:ListItem Value="2">Main/Control Account</asp:ListItem>
                <asp:ListItem Value="3">All Account</asp:ListItem>
                </asp:DropDownList>
                
                  <b><asp:Label ID="lbl_Date" runat="server" Text="As on"></asp:Label>            </b>
             <asp:TextBox ID="txt_Date" CssClass="DateTimePicker" placeholder="Date" Width="171px" runat="server" MaxLength="40" require="Select Date" validate="Rpt"></asp:TextBox>                  
