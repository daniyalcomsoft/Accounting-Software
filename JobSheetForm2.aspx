<%@ Page Language="C#" MasterPageFile="~/Main.master" AutoEventWireup="true" CodeFile="JobSheetForm2.aspx.cs" Inherits="JobSheetForm2" Title="Untitled Page" %>
            ...
            <table>
                ...
                <tr>
                    ...
                    <%--<asp:DropDownList runat="server" CssClass="input" id="ddlJobNo" AutoPostBack="true"
                     ...
                     <asp:TextBox ID="txtDate" runat="server" CssClass="gv_txtDate DateTimePicker" Width="120px" require="Enter Date" validate="SaveInvoice" ></asp:TextBox>   
                     </td>
                </tr>
                    ...
                    <asp:UpdatePanel ID="UpdatePanel3" runat="server">
                        <ContentTemplate>
                            <asp:GridView ID="GV_CommercialInvoiceDetail" Width="100%" runat="server" CssClass="data main"
                                ...
                                <Columns>
                                    <asp:TemplateField HeaderText="Job" ItemStyle-Width="86px">
                                        <ItemTemplate>
