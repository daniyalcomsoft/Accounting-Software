<%@ Page Title="Profit & Loss Statement" Language="C#" MasterPageFile="Main.master" AutoEventWireup="true" CodeFile="ProfitandLossReportSummary.aspx.cs" Inherits="ProfitandLossReportSummary" %>
        ...
        <b><asp:Label ID="lbl_From" runat="server" Text="From"></asp:Label>            </b>
         ...
         <td>
             ...
             <b><asp:Label ID="lbl_CostCenter" style="display:none;" runat="server" Text="Cost Center"></asp:Label>            </b>
              ...
              <td>
             <asp:DropDownList ID="ddlCostCenter" style="display:none;"  runat="server" AutoPostBack="false"> </asp:DropDownList>                 
              </td>
               <td>
