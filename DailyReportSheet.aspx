<%@ Page Language="C#" MasterPageFile="~/Main.master" AutoEventWireup="true" CodeFile="DailyReportSheet.aspx.cs" Inherits="DailyReportSheet" Title="Daily Report Sheet" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class="Heading">Daily Report Sheet</div>
    <div id="StausMsg">
    </div>
        <div>
           <table>
           ...
           <b><asp:Label ID="lbl_ReportDate" runat="server" Text="Date"></asp:Label>            </b>
           </td>
           <td>
           
             
             <asp:TextBox ID="txtReportDate" placeholder="Report Date" CssClass="DateTimePicker" Width="171px" runat="server" MaxLength="40" require="Enter Report Date" validate="Rpt"></asp:TextBox>                  
