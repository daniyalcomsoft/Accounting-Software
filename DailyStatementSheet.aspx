<%@ Page Language="C#" MasterPageFile="~/Main.master"  AutoEventWireup="true" CodeFile="DailyStatementSheet.aspx.cs" 
Inherits="DailyStatementSheet" Title="Daily Statement" %>
  ...
  <asp:HiddenField ID="hdnMaxDate" runat="server" />
        ...
        <%--<asp:UpdatePanel ID="MainUpdatePanel" runat="server">
           ...
           <asp:UpdatePanel ID="MainUpdatePanel" runat="server">
            ...
            placeholder="Account No"  Width="191px"></asp:TextBox>
            ...
            placeholder="From Date" ></asp:TextBox></td>
          <td>  <asp:Label ID="lbl_To" runat="server" Text="Select Date: " style="padding-left:5px;"></asp:Label></td>
         <td>   <asp:TextBox ID="txtDateTo" CssClass="DateTimePicker" Width="171px" runat="server" require="Select Date" 
            placeholder="Date" validate="Rpt"></asp:TextBox>
           </td>
           <td>
