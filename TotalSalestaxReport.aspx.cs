...
public partial class TotalSalestaxReport : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            foreach (DataRow dr in dtRole.Rows)
            {
                ...
                if (dtRole.Rows[row]["Page_Url"].ToString() == "TotalSalestaxReport.aspx")
                {
            ...
            {
                if (pageName == "TotalSalestaxReport.aspx" && view == true)
                {
                    ddlUser.DataBind();
    ...
    private void ConfigCrystalReport()
    {
        ...
        {
            reportPath = Server.MapPath("GL_Report\\TotalSalesTax_Report.rpt");
            rd.Load(reportPath);
    ...
    private DataTable getreport()
    {
        ...
        if (txt_DateFrom.Text != "" && txt_DateTo.Text != "")
        {
            ...
            con.Open();
            SqlCommand cmd = new SqlCommand("vt_SCGL_Sp_TotalSalesTaxReport", con);
    ...
    protected void lnkConYes_Click(object sender, EventArgs e)
    {
        ...
        if (GivenEPages != null)
        {
            ...
            lblDeleteMsg.Text = "Total Sales Tax Report Print Successfully ! ";
        }
        else
        {
            JQ.showDialog(this, "Confirmation");
