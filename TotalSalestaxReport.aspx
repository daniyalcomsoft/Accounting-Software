<%@ Page Language="C#" MasterPageFile="~/Main.master" AutoEventWireup="true" CodeFile="TotalSalestaxReport.aspx.cs" Inherits="TotalSalestaxReport" Title="Total Sales Tax Report" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class="Heading">Total Sales Tax Report</div>
    <div id="StausMsg">
    </div>
        <div> 
         <table>
