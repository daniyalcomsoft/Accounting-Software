<%@ Page Language="C#" MasterPageFile="~/Main.master" AutoEventWireup="true" CodeFile="DepositSheetForm_Views.aspx.cs" Inherits="DepositSheetForm_Views" 
Title="View Deposit Sheet" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <br />
   <div class="box_body">
        <div class="box_header"><span class="box_txt">Search Deposit Sheet</span></div>
        <div class="box_inner">
    ...
    <div class="box_header" style="margin-bottom: 8px;"><span class="box_txt">Manage Deposit Sheet</span></div>    
