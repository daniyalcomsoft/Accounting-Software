<%@ Page Language="C#" MasterPageFile="~/Main.master" AutoEventWireup="true" CodeFile="ExpenseSheetForm.aspx.cs" Inherits="ExpenseSheetForm" 
        ...
        <table style="width: 100%;">
            ...
            <tr>
                <td style="text-align: center;">
                    <b class="top_heading">EXPENSE SHEET</b>
                </td>
            </tr>
        </tbody></table>
    </div>
                ...
                <tr>
                    ...
                    <%--<asp:DropDownList runat="server" CssClass="input" id="ddlJobNo" AutoPostBack="true"
                     ...
                     <asp:TextBox ID="txtDate" runat="server" CssClass="gv_txtDate DateTimePicker" 
                            Width="120px" Height="30px" require="Enter Date" validate="SaveInvoice" 
                                ...
                                <Columns>
                                    <asp:TemplateField HeaderText="Job" ItemStyle-Width="150px">
                                       ...
                                       <%-- <asp:DropDownList runat="server" CssClass="input" id="ddlJobNo"
                                        ...
                                        <asp:TextBox ID="txtJobNo" runat="server" CssClass="gv_txtJobNo SmallTextbox"  style="width: 106px;" ontextchanged="txtJobNo_TextChanged" AutoPostBack="true" Text='<%#Bind("txtJobNo") %>'></asp:TextBox>   
                                        <%--require="Enter Amount" validate="SaveInvoice"--%>
                                    ...
                                    <asp:TemplateField HeaderText="Payment Type" ItemStyle-Width="110px">
                                        <ItemTemplate>
                                    ...
                                    <asp:TemplateField HeaderText="Clearing" ItemStyle-Width="50px">
                                        <ItemTemplate>
                                                <asp:CheckBox ID="chkClearing" runat="server" Enabled="false" /> 
                                        </ItemTemplate>
                                    ...
                                    <asp:TemplateField HeaderText="P.O No." ItemStyle-Width="84px">
                                        <ItemTemplate>
                                    ...
                                    <asp:TemplateField HeaderText="Impressed" ItemStyle-Width="114px">
                                        <ItemTemplate>
                                            <asp:DropDownList ID="ddlImpressed" runat="server" Enabled="false" require="Select Impressed" validate="SaveInvoice" style="width:122px;">
                                            </asp:DropDownList>
                                        </ItemTemplate>
                                    ...
                                    <asp:TemplateField HeaderText="Expense" ItemStyle-Width="114px">
                                        <ItemTemplate>
                                            <asp:DropDownList ID="ddlExpense" runat="server" Enabled="false" require="Select Expense" validate="SaveInvoice" style="width:122px;">
                                            </asp:DropDownList>
                                        </ItemTemplate>
                                        <ItemStyle Width="114px" />
                                    </asp:TemplateField> 
                                    
                                    <asp:TemplateField HeaderText="Payment Through" ItemStyle-Width="90px">
                                        <ItemTemplate>
                                            <asp:DropDownList ID="ddlPaymentThrough" runat="server" style="width:90px;">
                                       <%--     require="Select Payment Through Account" validate="SaveInvoice" custom="Select Payment Through Account" 
                                                customFn="var goal = parseInt(this.value); return goal > 0;"--%>
                                            </asp:DropDownList>
                                        </ItemTemplate>
                ...
                <div class="subtotal">
                    <table>
                        <tr>
                            ...
                            <td>
                                <input id="txttotal2" readonly="true" runat="server" class="subtotal_txt" style="height:30px; width:120px;" />
                            </td>
                        </tr>
                        </table>
                 </div>  
    ...
    <div id="FindAccount" style="padding: 0;">
          <asp:UpdatePanel ID="UpdatePanel1" runat="server">
             <ContentTemplate>
                 ...
                 &nbsp;<asp:TextBox ID="txtAccountNo" CssClass="autoCompleteCodes" style="width:130px;float: none;" runat="server"></asp:TextBox><asp:Button ID="btnFindAcc" runat="server" Text="Find" CssClass="buttonImp" 
                     style="float: none;width: 62px;height: 25px;line-height: 0px;margin-top: -18px;margin-left: 5px;" onclick="btnFindAcc_Click" />
                     <br />
