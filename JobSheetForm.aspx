<%@ Page Title="Create/Modify Job" Language="C#" MasterPageFile="~/Main.master" AutoEventWireup="true" CodeFile="JobSheetForm.aspx.cs" Inherits="JobSheetForm" %>
        ...
        <table style="width: 100%;">
            ...
            <tr>
                <td style="text-align: center;">
                    <b class="top_heading">JOB SHEET</b>
                </td>
            </tr>
        </tbody></table>
    </div>
       ...
       <asp:UpdateProgress ID="UpdateProgress1" runat="server">
        ...
        <div style="float:left;width:300px">
            <table>
                ...
                <tr>
                    ...
                    <asp:TextBox ID="txtDescription2" placeholder="Description" runat="server" TextMode="MultiLine" CssClass="textarea" style="width: 278px;height: 45px;"></asp:TextBox>
                    </td>
                </tr>
        ...
        <div style="float:right;width:300px">
            <table>
                ...
                <tr>
                    <td style="width:210px" colspan="2">
                    <asp:TextBox ID="txtCustomer" Width="276px"  runat="server" ReadOnly="true" Text="" CssClass="sam_textbox"></asp:TextBox>
                    </td>
                </tr>
                ...
                <tr>
                    <td style="width:210px" colspan="2">
                    <asp:TextBox ID="txtOtherDetails" placeholder="Other Details" runat="server" TextMode="MultiLine" CssClass="textarea" style="width: 278px;height: 45px;"></asp:TextBox>
                    </td>
                </tr>
                                ...
                                <Columns>
                                    <asp:TemplateField HeaderText="Date" ItemStyle-Width="86px">
                                        <ItemTemplate>
                                            ...
                                            <asp:TextBox ID="txtDate" runat="server" CssClass="gv_txtDate DateTimePicker" Width="86px" require="Enter Date" validate="SaveInvoice" Text='<%#Bind("txtDate") %>'></asp:TextBox>   
                                        </ItemTemplate>
                                    ...
                                    <asp:TemplateField HeaderText="P.O No." ItemStyle-Width="114px">
                                        <ItemTemplate>
                                                <asp:TextBox ID="txtPONo" runat="server" CssClass="gv_txtPONo SmallTextbox" Enabled="false" style="width: 106px;" validate="SaveInvoice" Text='<%#Bind("txtPONo") %>'></asp:TextBox>   
                                        </ItemTemplate>
                                    ...
                                    <asp:TemplateField HeaderText="Expense" ItemStyle-Width="114px">
                                        <ItemTemplate>
                                            <asp:DropDownList ID="ddlExpense" runat="server" Enabled="false" require="Select Expense" validate="SaveInvoice" style="width:135px;">
                                            </asp:DropDownList>
                                        </ItemTemplate>
                                        <ItemStyle Width="114px" />
                                    </asp:TemplateField> 
                                    
                                    <asp:TemplateField HeaderText="Payment Through" ItemStyle-Width="114px">
                                        <ItemTemplate>
                                            <asp:DropDownList ID="ddlPaymentThrough" runat="server" require="Select Payment Through Account" validate="SaveInvoice" custom="Select Payment Through Account" 
                                                customFn="var goal = parseInt(this.value); return goal > 0;" style="width:135px;">
                                            </asp:DropDownList>
                                        </ItemTemplate>
                                        <ItemStyle Width="114px" />
                                    </asp:TemplateField> 
                                    ...
                                    <asp:TemplateField HeaderText="Amount" ItemStyle-Width="114px">
                                        <ItemTemplate>
                                            <input id="txtAmount"  runat="server" class="gv_txtAmount SmallTextbox" style="width: 106px;text-align:right;" value='<%#Bind("txtAmount") %>' />
                                        </ItemTemplate>
                                        <ItemStyle Width="114px" />
                                    </asp:TemplateField>
