<%@ Page Language="C#" MasterPageFile="~/Main.master" AutoEventWireup="true" CodeFile="SalesTaxInvoice_Report.aspx.cs" 
Inherits="SalesTaxInvoice_Report" Title="Sales Tax Invoice Report" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class="Heading">Sales Tax Invoice Report</div>
    <div id="StausMsg">
    </div>
        <div>
           <table>
           ...
           <b><asp:Label ID="lbl_Date" runat="server" Text="Sales Tax Invoice ID"></asp:Label>            </b>
           </td>
           <td>
           
             
             <asp:TextBox ID="txtSalesInvoiceID" placeholder="Sales Tax Invoice ID" Width="171px" runat="server" MaxLength="40" require="Enter Sales Tax Invoice ID" validate="Rpt"></asp:TextBox>                  
