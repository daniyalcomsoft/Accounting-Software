...
public partial class ProfitandLossReportSummary : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            foreach (DataRow dr in dtRole.Rows)
            {
                ...
                if (dtRole.Rows[row]["Page_Url"].ToString() == "ProfitandLossReportSummary.aspx")
                {
            ...
            {
                if (pageName == "ProfitandLossReportSummary.aspx" && view == true)
                {
                    Bind_CostCenter();
                    ConfigCrystalReport();
    ...
    private void ConfigCrystalReport()
    {
        ...
        {
            string reportPath = Server.MapPath("GL_Report\\ProfitLoss2.rpt");
            rd.Load(reportPath);
    ...
    private DataTable getreport()
    {
        ...
        if (txt_DateFrom.Text != "" && txt_DateTo.Text != "")
        {
            ...
            SqlCommand cmd = new SqlCommand("vt_SCGL_Sp_Profitandloss_trial4", con);
    ...
    protected void lnkConYes_Click(object sender, EventArgs e)
    {
        ...
        if (GivenEPages != null)
        {
            ...
            lblDeleteMsg.Text = "Profit And Loss Statement Report Print Successfully ! ";
        }
        else
        {
            JQ.showDialog(this, "Confirmation");
