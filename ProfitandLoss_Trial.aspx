<%@ Page Title="Profit & Loss Statement" Language="C#" MasterPageFile="Main.master" AutoEventWireup="true" CodeFile="ProfitandLoss_Trial.aspx.cs" Inherits="ProfitandLoss_Trial" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class="Heading">Profit & Loss Trial</div>
    <div id="StausMsg">
    </div>
        <div> 
         <table>
                        <tr>
                            <td>
        <b><asp:Label ID="lbl_From" runat="server" Text="From"></asp:Label>            </b>
        </td>
         <td>
             <asp:TextBox ID="txt_DateFrom" CssClass="DateTimePicker" placeholder="Date" Width="171px" runat="server" MaxLength="40" require="Select Date" validate="Rpt"></asp:TextBox>
              ...
              <td><b><asp:Label ID="lbl_To" runat="server" Text="To"></asp:Label>            </b>
              </td>
              <td>
             <asp:TextBox ID="txt_DateTo" CssClass="DateTimePicker" placeholder="Date" Width="171px" runat="server" MaxLength="40" require="Select Date" validate="Rpt"></asp:TextBox>
              ...
              <td>
             <b><asp:Label ID="lbl_CostCenter" runat="server" Text="Cost Center" visible="false"></asp:Label>            </b>
              </td>
              <td>
             <asp:DropDownList ID="ddlCostCenter"  runat="server" AutoPostBack="false" visible="false"> </asp:DropDownList>                 
              </td>
              <td>
             <b><asp:Label ID="lbl_ZeroField" runat="server" Text="With Zero Balance"></asp:Label>            </b>
              </td>
              <td>
             <asp:CheckBox ID="ChkBox_ZeroField" runat="server"></asp:CheckBox>
              </td>
               <td>
