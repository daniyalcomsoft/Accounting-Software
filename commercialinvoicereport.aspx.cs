...
public partial class commercialinvoicereport : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            foreach (DataRow dr in dtRole.Rows)
            {
                ...
                if (dtRole.Rows[row]["Page_Url"].ToString() == "commercialinvoicereport.aspx")
                {
            ...
            {
                if (pageName == "commercialinvoicereport.aspx" && view == true)
                {
                    //ConfigCrystalReport();
    ...
    private void ConfigCrystalReport()
    {
        ...
        if (txtCommInvoiceID.Text != "")
        {
            string reportPath = Server.MapPath("GL_Report\\CommercialInvoiceReport_New_Main.rpt");
            rd.Load(reportPath);
    ...
    private DataTable getreport()
    {
        ...
        if (txtCommInvoiceID.Text != "")
        {
            ...
            con.Open();
            //SqlCommand cmd = new SqlCommand("vt_SCGL_rptCommercialInvoice", con);
            SqlCommand cmd = new SqlCommand("vt_SCGL_rptCommercialInvoice_Duties", con);
            cmd.CommandType = CommandType.StoredProcedure;
            SCGL_Session SBO = (SCGL_Session)Session["SessionBO"];
            cmd.Parameters.AddWithValue("@CommercialInvoiceID", txtCommInvoiceID.Text);
            SqlDataAdapter adpt = new SqlDataAdapter(cmd);
            adpt.Fill(ds);
            SqlCommand cmd2 = new SqlCommand("vt_SCGL_rptCommercialInvoice", con);
            cmd2.CommandType = CommandType.StoredProcedure;
            cmd2.Parameters.AddWithValue("@CommercialInvoiceID", txtCommInvoiceID.Text);
            ...
            dt.Columns.Add("txtCustInvoiceNo");
            ...
            foreach (DataRow dr in dt.Rows)
            {
                ...
                dr["txtRefNo"] = "Reference No:";
                dr["txtCustInvoiceNo"] = "Customer Inv No:";
                dr["txtDate"] = "Date:";
