<%@ Page Language="C#" MasterPageFile="~/Main.master" AutoEventWireup="true" CodeFile="CNFImportValueReport.aspx.cs" Inherits="CNFImportValueReport" Title="Untitled Page" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class="Heading">CNF Import Value Report</div>
    <div id="StausMsg">
    </div>
        <div> 
         <table>
