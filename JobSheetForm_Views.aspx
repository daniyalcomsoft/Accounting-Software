<%@ Page Title="View Jobs" Language="C#" MasterPageFile="~/Main.master" AutoEventWireup="true" CodeFile="JobSheetForm_Views.aspx.cs" Inherits="JobSheetForm_Views" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <br />
   <div class="box_body">
        <div class="box_header"><span class="box_txt">Search Job Sheet</span></div>
        <div class="box_inner">
    ...
    <div class="box_header" style="margin-bottom: 8px;"><span class="box_txt">Manage Job Sheet</span></div>    
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
    <ContentTemplate>
        <asp:GridView ID="GridJobSheetView" runat="server" CssClass="data main" AutoGenerateColumns="False"
            ...
            <Columns>        
                ...
                <asp:TemplateField HeaderText="Edit" HeaderStyle-Width="31px">
                    <ItemTemplate>
                        ...
                        CommandArgument='<%# Eval("JobSheetID") %>' OnCommand="LbtnEdit_Command" ></asp:LinkButton>
                    </ItemTemplate>
                </asp:TemplateField>
                ...
                <asp:TemplateField HeaderText="Delete" HeaderStyle-Width="41px">
                    <ItemTemplate>
                        ...
                        CommandArgument='<%# Eval("JobSheetID") %>' OnCommand="lbtnDelete_Command"></asp:LinkButton>
                    </ItemTemplate>
                </asp:TemplateField>            
