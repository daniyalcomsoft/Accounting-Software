<%@ Page Language="C#" MasterPageFile="~/Main.master"  AutoEventWireup="true" CodeFile="GL_Subsidiary.aspx.cs" 
Inherits="GL_Subsidiary" Title="Subsidiary Ledger" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
  ...
  <asp:HiddenField ID="hdnMaxDate" runat="server" />
        ...
        <%--<asp:UpdatePanel ID="MainUpdatePanel" runat="server">
            <ContentTemplate>--%>
            <div class="Heading">Subsidary Ledger</div>
            <div id="StausMsg">
            </div>
            <div>
             <table>
                        <tr>
                            <td>
            <asp:Label ID="Label1" runat="server" Text="Account" style="margin-left:64px;"></asp:Label>
            </td>
           <td>
           <asp:UpdatePanel ID="MainUpdatePanel" runat="server">
            <ContentTemplate>
            <asp:TextBox ID="txtCode" runat="server" AutoComplete="Off" CssClass="autoCompleteCodes" 
            placeholder="Account No" require="Select Account" validate="Rpt" Width="191px"></asp:TextBox>
            ...
            <asp:LinkButton ID="lnkbtnfind2" runat="server" CausesValidation="False" CssClass="search"
             ...
             <td>
            <asp:Label ID="lbl_From" runat="server" Text="From" style="padding-left:5px;"></asp:Label>
            </td>
            <td>
            <asp:TextBox ID="txtDateFrom" CssClass="DateTimePicker" Width="171px" runat="server" 
            placeholder="From Date" require="Select Date" validate="Rpt"></asp:TextBox></td>
          <td>  <asp:Label ID="lbl_To" runat="server" Text="To" style="padding-left:5px;"></asp:Label></td>
         <td>   <asp:TextBox ID="txtDateTo" CssClass="DateTimePicker" Width="171px" runat="server" require="Select Date" 
            placeholder="To Date" validate="Rpt"></asp:TextBox>
           </td>
           <td>
          ...
          <asp:UpdatePanel ID="UpdatePanel21" runat="server">
            ...
            <%--<CR:CrystalReportViewer ID="CrystalReportViewer1" runat="server" 
                ...
                <CR:CrystalReportViewer ID="CrystalReportViewer1" runat="server" AutoDataBind="true"
                               ...
                               HasZoomFactorList="False" onload="CrystalReportViewer1_Load" />
            </div>
      <%--  </ContentTemplate>
     </asp:UpdatePanel>--%>
     </div>
