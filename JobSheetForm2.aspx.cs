...
public partial class JobSheetForm2 : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            foreach (DataRow dr in dtRole.Rows)
            {
                ...
                if (dtRole.Rows[row]["Page_Url"].ToString() == "JobSheetForm2.aspx")
                {
            ...
            {
                if (pageName == "JobSheetForm2.aspx" && view == true)
                {
        ...
        try
        {
            ...
            if (JobID > 0)
            {
                ...
                for (int i = 0; i < dt.Rows.Count; i++)
                {
                    ...
                    BALInvoice.JobNo = SCGL_Common.Convert_ToInt(dt.Rows[i]["ddlJobNo_value"].ToString());
