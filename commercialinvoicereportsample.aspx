<%@ Page Title="" Language="C#" MasterPageFile="~/Main.master" AutoEventWireup="true" CodeFile="commercialinvoicereportsample.aspx.cs" Inherits="commercialinvoicereportsample" %>
                ...
                <div>
                    <table>
                        <tr>
                            ...
                            <td>
                                <asp:TextBox ID="txtFromDate" placeholder="From Date" CssClass="datepicker" Width="150px" runat="server"></asp:TextBox>
                            </td>
                            <td>
                                <label>
                                    To:</label>
                            ...
                            <td>
                                <asp:TextBox ID="txtToDate" placeholder="To Date" CssClass="datepicker" Width="150px" runat="server"></asp:TextBox>
                            </td>
                            <td>
                                <asp:Button ID="btnSearch" runat="server" CssClass="buttonImp"
                                    Style="float: none" onclick="btnSearch_Click" Text="Search" />
                            </td>
                            <td>
