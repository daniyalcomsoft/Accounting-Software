    ...
    public class ShippingLine_DAL
    {
        ...
        public virtual int Create(ShippingLine_BAL p,SqlTransaction trans)
        {
            try
            {
                ...
                return Convert.ToInt32(SqlHelper.ExecuteScalar(trans, "VT_SP_ShippingLine_Insert", SqlParam));
            }
            catch (Exception ex)
            {
                throw ex;
        ...
        public virtual ShippingLine_BAL Read(int p)
        {
            try
            {
                ...
                using (SqlDataReader dr = SqlHelper.ExecuteReader(SCGL_Common.ConnectionString, "VT_SP_ShippingLine_Read", SqlParam))
                {
                    obj = DataReader(dr);
                }
                return obj;
        ...
        public virtual DataTable ReadDataTable()
        {
            try
            {
                return SqlHelper.ExecuteDataset(SCGL_Common.ConnectionString, "VT_SP_ShippingLine_Read").Tables[0];
            }
            catch (Exception ex)
            {
                throw ex;
        ...
        public virtual List<ShippingLine_BAL> Read()
        {
            try
            {
                ...
                using (SqlDataReader dr = SqlHelper.ExecuteReader(SCGL_Common.ConnectionString, "VT_SP_ShippingLine_Read"))
                {
        ...
        public virtual bool Update(ShippingLine_BAL p)
        {
            try
            {
                SqlParameter[] SqlParam = new SqlParameter[] {
                        ...
                        new SqlParameter("ShippingLine", p.ShippingLine)};
                int i = SqlHelper.ExecuteNonQuery(SCGL_Common.ConnectionString, "VT_SP_ShippingLine_Update", SqlParam);
                return i >= 1;
            }
            catch (Exception ex)
            {
        ...
        public virtual bool Delete(int p)
        {
            ...
            {
                SqlParameter SqlParam = new SqlParameter("ShippingLineID", p);
                int i = SqlHelper.ExecuteNonQuery(SCGL_Common.ConnectionString, "VT_SP_ShippingLine_Delete", SqlParam);
                return i >= 1;
