    ...
    public class DAL_InvoiceDetail
    {
        ...
        public virtual int Create(InvoiceDetail p)
        {
            try
            {
                ...
                return Convert.ToInt32(SqlHelper.ExecuteScalar(SCGL_Common.ConnectionString, "VT_SP_InvoiceDetail_Insert", SqlParam));
            }
            catch (Exception ex)
            {
                throw ex;
        ...
        public virtual InvoiceDetail Read(int p)
        {
            try
            {
                ...
                using (SqlDataReader dr = SqlHelper.ExecuteReader(SCGL_Common.ConnectionString, "VT_SP_InvoiceDetail_Read", SqlParam))
                {
                obj = DataReader(dr);
                }
                return obj;
        ...
        public virtual DataTable ReadDataTable()
        {
            try
            {
                return SqlHelper.ExecuteDataset(SCGL_Common.ConnectionString, "VT_SP_InvoiceDetail_Read").Tables[0];
            }
            catch (Exception ex)
            {
                throw ex;
        ...
        public virtual List<InvoiceDetail> Read()
        {
            try
            {
                ...
                using (SqlDataReader dr = SqlHelper.ExecuteReader(SCGL_Common.ConnectionString, "VT_SP_InvoiceDetail_Read"))
                {
        ...
        public virtual bool Update(InvoiceDetail p)
        {
            try
            {
                SqlParameter[] SqlParam = new SqlParameter[] {
                        ...
                        new SqlParameter("ByParty", p.ByParty),
                        new SqlParameter("ByUS", p.ByUS)};
                int i = SqlHelper.ExecuteNonQuery(SCGL_Common.ConnectionString, "VT_SP_InvoiceDetail_Update", SqlParam);
                return i >= 1;
            }
            catch (Exception ex)
            {
        ...
        public virtual bool Delete(int p)
        {
            ...
            {
                SqlParameter SqlParam = new SqlParameter("InvoiceDetailID", p);
                int i = SqlHelper.ExecuteNonQuery(SCGL_Common.ConnectionString, "VT_SP_InvoiceDetail_Delete", SqlParam);
                return i >= 1;
            }
            catch (Exception ex)
            {
