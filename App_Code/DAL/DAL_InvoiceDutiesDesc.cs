    ...
    public class DAL_InvoiceDutiesDesc
    {
        ...
        public virtual int Create(InvoiceDutiesDesc p)
        {
            try
            {
                ...
                return Convert.ToInt32(SqlHelper.ExecuteScalar(SCGL_Common.ConnectionString, "VT_SP_InvoiceDutiesDesc_Insert", SqlParam));
            }
            catch (Exception ex)
            {
                throw ex;
        ...
        public virtual InvoiceDutiesDesc Read(int p)
        {
            try
            {
                ...
                using (SqlDataReader dr = SqlHelper.ExecuteReader(SCGL_Common.ConnectionString, "VT_SP_InvoiceDutiesDesc_Read", SqlParam))
                {
                obj = DataReader(dr);
                }
                return obj;
        ...
        public virtual DataTable ReadDataTable()
        {
            try
            {
                return SqlHelper.ExecuteDataset(SCGL_Common.ConnectionString, "VT_SP_InvoiceDutiesDesc_Read").Tables[0];
            }
            catch (Exception ex)
            {
                throw ex;
        ...
        public virtual List<InvoiceDutiesDesc> Read()
        {
            try
            {
                ...
                using (SqlDataReader dr = SqlHelper.ExecuteReader(SCGL_Common.ConnectionString, "VT_SP_InvoiceDutiesDesc_Read"))
                {
        ...
        public virtual bool Update(InvoiceDutiesDesc p)
        {
            try
            {
                SqlParameter[] SqlParam = new SqlParameter[] {
                        ...
                        new SqlParameter("InvoiceDutiesDescription", p.InvoiceDutiesDescription)};
                int i = SqlHelper.ExecuteNonQuery(SCGL_Common.ConnectionString, "VT_SP_InvoiceDutiesDesc_Update", SqlParam);
                return i >= 1;
            }
            catch (Exception ex)
            {
        ...
        public virtual bool Delete(int p)
        {
            ...
            {
                SqlParameter SqlParam = new SqlParameter("InvoiceDutiesDescID", p);
                int i = SqlHelper.ExecuteNonQuery(SCGL_Common.ConnectionString, "VT_SP_InvoiceDutiesDesc_Delete", SqlParam);
                return i >= 1;
            }
            catch (Exception ex)
            {
