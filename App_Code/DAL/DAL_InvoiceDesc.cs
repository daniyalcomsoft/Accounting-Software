    ...
    public class DAL_InvoiceDesc
    {
        ...
        public virtual int Create(InvoiceDesc p)
        {
            try
            {
                ...
                return Convert.ToInt32(SqlHelper.ExecuteScalar(SCGL_Common.ConnectionString, "VT_SP_InvoiceDesc_Insert", SqlParam));
            }
            catch (Exception ex)
            {
                throw ex;
        ...
        public virtual InvoiceDesc Read(int p)
        {
            try
            {
                ...
                using (SqlDataReader dr = SqlHelper.ExecuteReader(SCGL_Common.ConnectionString, "VT_SP_InvoiceDesc_Read", SqlParam))
                {
                obj = DataReader(dr);
                }
                return obj;
        ...
        public virtual DataTable ReadDataTable()
        {
            try
            {
                return SqlHelper.ExecuteDataset(SCGL_Common.ConnectionString, "VT_SP_InvoiceDesc_Read").Tables[0];
            }
            catch (Exception ex)
            {
                throw ex;
        ...
        public virtual List<InvoiceDesc> Read()
        {
            try
            {
                ...
                using (SqlDataReader dr = SqlHelper.ExecuteReader(SCGL_Common.ConnectionString, "VT_SP_InvoiceDesc_Read"))
                {
        ...
        public virtual bool Update(InvoiceDesc p)
        {
            try
            {
                SqlParameter[] SqlParam = new SqlParameter[] {
                        ...
                        new SqlParameter("InvoiceDescription", p.InvoiceDescription)};
                int i = SqlHelper.ExecuteNonQuery(SCGL_Common.ConnectionString, "VT_SP_InvoiceDesc_Update", SqlParam);
                return i >= 1;
            }
            catch (Exception ex)
            {
        ...
        public virtual bool Delete(int p)
        {
            ...
            {
                SqlParameter SqlParam = new SqlParameter("InvoiceDescID", p);
                int i = SqlHelper.ExecuteNonQuery(SCGL_Common.ConnectionString, "VT_SP_InvoiceDesc_Delete", SqlParam);
                return i >= 1;
            }
            catch (Exception ex)
            {
