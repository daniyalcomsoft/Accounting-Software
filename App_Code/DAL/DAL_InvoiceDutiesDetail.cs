    ...
    public class DAL_InvoiceDutiesDetail
    {
        ...
        public virtual int Create(InvoiceDutiesDetail p)
        {
            try
            {
                ...
                return Convert.ToInt32(SqlHelper.ExecuteScalar(SCGL_Common.ConnectionString, "VT_SP_InvoiceDutiesDetail_Insert", SqlParam));
            }
            catch (Exception ex)
            {
                throw ex;
        ...
        public virtual InvoiceDutiesDetail Read(int p)
        {
            try
            {
                ...
                using (SqlDataReader dr = SqlHelper.ExecuteReader(SCGL_Common.ConnectionString, "VT_SP_InvoiceDutiesDetail_Read", SqlParam))
                {
                obj = DataReader(dr);
                }
                return obj;
        ...
        public virtual DataTable ReadDataTable()
        {
            try
            {
                return SqlHelper.ExecuteDataset(SCGL_Common.ConnectionString, "VT_SP_InvoiceDutiesDetail_Read").Tables[0];
            }
            catch (Exception ex)
            {
                throw ex;
        ...
        public virtual List<InvoiceDutiesDetail> Read()
        {
            try
            {
                ...
                using (SqlDataReader dr = SqlHelper.ExecuteReader(SCGL_Common.ConnectionString, "VT_SP_InvoiceDutiesDetail_Read"))
                {
        ...
        public virtual List<InvoiceDutiesDetail> ReadByInvoiceID(int InvoiceID)
        {
            try
            {
                ...
                List<InvoiceDutiesDetail> obj = new List<InvoiceDutiesDetail>();
                using (SqlDataReader dr = SqlHelper.ExecuteReader(SCGL_Common.ConnectionString, CommandType.Text, query, p))
                {
                    obj = ListDataReader(dr);
                }
                return obj;
        ...
        public virtual bool Update(InvoiceDutiesDetail p)
        {
            try
            {
                SqlParameter[] SqlParam = new SqlParameter[] {
                        ...
                        new SqlParameter("ByParty", p.DutiesByParty),
                        new SqlParameter("ByUS", p.DutiesByUS)};
                int i = SqlHelper.ExecuteNonQuery(SCGL_Common.ConnectionString, "VT_SP_InvoiceDutiesDetail_Update", SqlParam);
                return i >= 1;
            }
            catch (Exception ex)
            {
        ...
        public virtual bool Delete(int p)
        {
            ...
            {
                SqlParameter SqlParam = new SqlParameter("InvoiceDutiesDetailID", p);
                int i = SqlHelper.ExecuteNonQuery(SCGL_Common.ConnectionString, "VT_SP_InvoiceDutiesDetail_Delete", SqlParam);
                return i >= 1;
            }
            catch (Exception ex)
            {
