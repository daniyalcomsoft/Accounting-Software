<%@ Page Title="View Customers" Language="C#" MasterPageFile="~/Main.master" AutoEventWireup="true" 
CodeFile="CustomerForm_Views.aspx.cs" Inherits="CustomerForm_Views" %>
            ...
            <tr>
                ...
                <td style="text-align: right; width: 328px;">
                    <asp:LinkButton ID="btnCancel" CssClass="buttonImp" runat="server" onclick="btnCancel_Click" 
                        >Create Customer</asp:LinkButton>
                </td>    
            </tr>
        </table>
    </div>
...
<br />
   <div class="box_body">
        <div class="box_header"><span class="box_txt">Search Customer</span></div>
        <div class="box_inner">
    ...
    <div class="box_header" style="margin-bottom: 8px;"><span class="box_txt">Manage Customer</span></div>
 
    
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
        <asp:GridView ID="GridCustomerView" runat="server" CssClass="data main" AutoGenerateColumns="False"
        DataKeyNames="CustomerID" AllowPaging="true" PageSize="15" 
        ...
        <Columns>        
            ...
            <asp:TemplateField HeaderText="View" HeaderStyle-Width="35px">
                <ItemTemplate>
                    <asp:LinkButton ID="lbtnView" runat="server" cssClass="view"
                        CommandArgument='<%# Eval("CustomerID") %>' oncommand="lbtnView_Command"></asp:LinkButton>
                </ItemTemplate>
            </asp:TemplateField>
            <asp:TemplateField HeaderText="Edit" HeaderStyle-Width="31px">
                <ItemTemplate>
                    <asp:LinkButton ID="LbtnEdit" runat="server" cssClass="edit"
                        CommandArgument='<%# Eval("CustomerID") %>' oncommand="LbtnEdit_Command"></asp:LinkButton>
                </ItemTemplate>
            </asp:TemplateField>
            <asp:TemplateField HeaderText="Delete" HeaderStyle-Width="41px">
                <ItemTemplate>
                    ...
                    CommandArgument='<%# Eval("CustomerID") %>' OnCommand="lbtnDelete_Command"></asp:LinkButton>
                </ItemTemplate>
            </asp:TemplateField>
