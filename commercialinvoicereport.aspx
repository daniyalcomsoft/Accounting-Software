<%@ Page Title="Commercial Invoice Report" Language="C#" MasterPageFile="~/Main.master" AutoEventWireup="true" 
CodeFile="commercialinvoicereport.aspx.cs" Inherits="commercialinvoicereport" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class="Heading">Commercial Invoice Report</div>
    <div id="StausMsg">
    </div>
        <div>
           <table>
           ...
           <b><asp:Label ID="lbl_CommInvID" runat="server" Text="Commercial Invoice ID"></asp:Label>            </b>
           </td>
           <td>
           
             
             <asp:TextBox ID="txtCommInvoiceID" placeholder="Commercial Invoice ID" Width="171px" runat="server" MaxLength="40" require="Enter Commercial Invoice ID" validate="Rpt"></asp:TextBox>                  
